...
const HeroSection = () => {
  const IMAGES = {
    MAIN_DISH: "https://ik.imagekit.io/99o04eudvr/img_getfood/teste?updatedAt=1752108584071",
    CUSTOMER_AVATAR_1: "https://ik.imagekit.io/99o04eudvr/img_getfood/pessoa1.png",
    CUSTOMER_AVATAR_2: "https://ik.imagekit.io/99o04eudvr/img_getfood/pessoa2.png",
    CUSTOMER_AVATAR_3: "https://ik.imagekit.io/99o04eudvr/img_getfood/pessoa3.png",
    ...
    SERVICE_IMAGE_1: "https://ik.imagekit.io/99o04eudvr/img_getfood/serv1(1).png?updatedAt=1752172164641",
    SERVICE_IMAGE_2: "https://ik.imagekit.io/99o04eudvr/img_getfood/serv2.png?updatedAt=1752172518380",
    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Garanta a <span className="text-[#ff5d00]">Melhor Oferta</span> em Fast Food & <span className="text-[#ff5d00]">Restaurantes</span>
            </h1>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 pt-6">
              <div className="flex -space-x-2">
                <img src={IMAGES.CUSTOMER_AVATAR_1} className="w-10 h-10 rounded-full border-2 border-white object-cover" alt="Cliente 1" />
                <img src={IMAGES.CUSTOMER_AVATAR_2} className="w-10 h-10 rounded-full border-2 border-white object-cover" alt="Cliente 2" />
                <img src={IMAGES.CUSTOMER_AVATAR_3} className="w-10 h-10 rounded-full border-2 border-white object-cover" alt="Cliente 3" />
              </div>
              <div>
                <p className="font-bold text-gray-900">Nossos Clientes Satisfeitos</p>
                <div className="flex items-center gap-1">
                   <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                   <p className="text-sm font-semibold text-gray-800">4.8 <span className="font-normal text-gray-500">(12.5k Avaliações)</span></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex justify-center items-center">
            ...
            <div className="w-[350px] h-[350px] md:w-[420px] md:h-[420px] rounded-full bg-gray-100 shadow-2xl flex items-center justify-center z-10">
              <img src={IMAGES.MAIN_DISH} alt="Prato principal" className="object-cover w-full h-full scale-110" />
            </div>
            
            <div className="absolute top-28 -left-10 bg-white p-3 rounded-xl shadow-lg flex items-center gap-3 z-20 w-48">
              <img src={IMAGES.CHEF_AVATAR} className="w-10 h-10 rounded-full object-cover" alt="Entregador" />
              <div>
            ...
            <div className="absolute -bottom-8 right-0 bg-white p-3 rounded-xl shadow-lg flex items-start gap-3 z-20 w-52">
              <img src={IMAGES.PRODUCT_IMAGE} className="w-16 h-16 rounded-xl object-cover" alt="Pizza Italiana" />
              <div>
                <p className="text-sm font-bold text-gray-800">Pizza Italiana</p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <p className="text-[#ff5d00] text-base font-semibold tracking-wider uppercase mb-2">O que servimos</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="text-center space-y-4">
                <img src={service.image} alt={service.title} className="mx-auto w-80 h-40 object-contain" />
